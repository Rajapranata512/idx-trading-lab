...
class BacktestSettings(BaseModel):
    ...
    liq_bucket_mid_avg_volume_20d: float = 750000
    liq_bucket_high_avg_volume_20d: float = 2000000
    slippage_multiplier_low_liq: float = 1.5
    slippage_multiplier_mid_liq: float = 1.0
    slippage_multiplier_high_liq: float = 0.8
